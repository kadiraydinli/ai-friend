...
const FriendForm = ({ initialData, categories }: FriendFormProps) => {
                ...
                >
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="col-span-2 md:col-span-1">
                                ...
                                <FormDescription>
                                    Describe in detail your friend&apos;s backstory and relevant details.
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <div className="w-full flex justify-center">
                        <Button size="lg" disabled={isLoading}>
                            {initialData ? "Edit your friend" : "Create your friend"}
